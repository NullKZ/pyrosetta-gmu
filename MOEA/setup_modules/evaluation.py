...
def evaluation(eaObj, initcfg):
    ...
    eaObj.hbond_sr.set_weight(hbond_sr_bb, 1.0)
    eaObj.hbond_lr = ScoreFunction()
    eaObj.hbond_lr.set_weight(hbond_lr_bb, 1.0)
    eaObj.other = create_score_function("score4_smooth")
    eaObj.other.set_weight(hbond_sr_bb, 0)
    eaObj.other.set_weight(hbond_lr_bb, 0)